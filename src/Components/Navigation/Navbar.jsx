...
function Navbar() {
  ...
  const { setNavActive, Selected } = useContext(AppContext);
  ...
  return (
    <div className="fixed top-0 z-[99] w-full">
      <div className="w-full flex justify-between  navbar">
        ...
        {RouteName.pathname == "/" ? (
          <div
            ...
            className="flex relative justify-center items-end flex-col h-14 w-[32vw] md:w-[18vw] group bg-black px-4 gap-1 z-[2] "
          >
            <div className="bg-white w-[40%] md:w-[25%] h-[2px] group-hover:bg-black relative z-[2]"></div>
            <div className="bg-white w-[25%] md:w-[14%] h-[2px] group-hover:bg-black relative z-[2]"></div>
          ...
          <div className="flex font-[font2]  text-[14px] sm:text-[19px]">
            ...
            >
              ...
              <div className="link-name hidden md:flex w-full h-22 transition-all duration-150 justify-start items-end">
                <p className="px-3 py-1 group-hover:text-black relative z-[2]">
                  Menu
                </p>
              </div>
      ...
      {Selected && 
      <div className="border-y-2 bg-white py-1 px-2 w-full flex justify-between font-[font2] text-[3vw] md:text-[2vw]">
        <p>{Selected.name}</p>
        <p>{Selected.title}</p>
        <p>{Selected.year}</p>
        </div>}
