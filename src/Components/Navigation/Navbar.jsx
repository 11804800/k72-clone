...
function Navbar() {
  ...
  return (
    <div className='fixed flex top w-full justify-between items-start z-[9999] p-5'>
        <div >
    ...
    }} className='w-[18vw]  h-10 relative bg-black'>
        <div ref={NavRef} className='w-full transition-all h-0 bg-[#d3fd50] absolute top-0'></div>
        <div onClick={()=>setNavActive(true)} className='relative flex flex-col gap-1 px-12 justify-center items-end h-full'>
